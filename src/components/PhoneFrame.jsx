...
export default function PhoneFrame({ children }) {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-slate-200 to-slate-300 p-8">
      {/* Bezel — fixed 390x844; shrink-0 so flexbox never scales it down on a narrow viewport */}
