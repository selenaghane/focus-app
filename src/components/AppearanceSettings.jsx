...
// Heads up: these controls hold their own state and respond to touch, but
// none of them restyle the app yet. Wiring dark mode up means threading a
// theme through every surface, which is its own pass.
